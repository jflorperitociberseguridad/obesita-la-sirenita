...
<body class="bg-blue-50 text-gray-800 antialiased">
    ...
    <header id="header" class="bg-white/90 backdrop-blur-lg shadow-md sticky top-0 z-50 transition-all duration-300">
        <div class="container mx-auto px-4 py-3">
            <div class="flex justify-between items-center">
                ...
                <nav class="hidden md:flex items-center space-x-1 lg:space-x-3" aria-label="Navegación principal">
                    <a href="#values" class="nav-link px-3 py-2 rounded-md text-gray-600 hover:bg-blue-100 hover:text-blue-700 font-semibold transition-colors">Valores</a>
                    <a href="#book" class="nav-link px-3 py-2 rounded-md text-gray-600 hover:bg-blue-100 hover:text-blue-700 font-semibold transition-colors">El Cuento</a>
                    <a href="#create-story" class="nav-link px-3 py-2 rounded-md text-gray-600 hover:bg-blue-100 hover:text-blue-700 font-semibold transition-colors">Crea un Cuento</a>
                    <a href="#mission" class="nav-link px-3 py-2 rounded-md text-gray-600 hover:bg-blue-100 hover:text-blue-700 font-semibold transition-colors">Misión</a>
                    <a href="#author" class="nav-link px-3 py-2 rounded-md text-gray-600 hover:bg-blue-100 hover:text-blue-700 font-semibold transition-colors">Autora</a>
                    <a href="#team" class="nav-link px-3 py-2 rounded-md text-gray-600 hover:bg-blue-100 hover:text-blue-700 font-semibold transition-colors">Equipo</a>
        ...
        <nav id="mobileMenu" class="md:hidden bg-white border-t border-gray-200 hidden">
            <div class="px-4 pt-2 pb-4 space-y-2">
                <a href="#values" class="nav-link block px-3 py-2 rounded-md text-gray-700 hover:bg-blue-50 font-semibold">Valores</a>
                <a href="#book" class="nav-link block px-3 py-2 rounded-md text-gray-700 hover:bg-blue-50 font-semibold">El Cuento</a>
                <a href="#create-story" class="nav-link block px-3 py-2 rounded-md text-gray-700 hover:bg-blue-50 font-semibold">Crea un Cuento</a>
                <a href="#mission" class="nav-link block px-3 py-2 rounded-md text-gray-700 hover:bg-blue-50 font-semibold">Misión</a>
                <a href="#author" class="nav-link block px-3 py-2 rounded-md text-gray-700 hover:bg-blue-50 font-semibold">Autora</a>
                <a href="#team" class="nav-link block px-3 py-2 rounded-md text-gray-700 hover:bg-blue-50 font-semibold">Equipo</a>
    ...
    <footer class="bg-blue-900 text-white">
        <div class="container mx-auto px-6 py-12">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
                <div class="flex flex-col items-center text-center md:items-start md:text-left">
                    <a href="#home" class="flex items-center space-x-3 mb-4" aria-label="Inicio de Obesita la Sirenita">
                        ...
                        <span class="text-xl font-bold comic-font">Obesita la Sirenita</span>
                    </a>
                    <p class="text-blue-200 text-sm mb-6 max-w-xs">
                        Inspirando a los niños a amarse a sí mismos y a cuidar nuestro planeta.
                    </p>
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        <li><a href="#values" class="text-blue-200 hover:text-white transition-colors">Valores</a></li>
                        <li><a href="#book" class="text-blue-200 hover:text-white transition-colors">El Cuento</a></li>
                        <li><a href="#author" class="text-blue-200 hover:text-white transition-colors">Autora</a></li>
                        <li><a href="#team" class="text-blue-200 hover:text-white transition-colors">Equipo</a></li>
                        <li><a href="#contact" class="text-blue-200 hover:text-white transition-colors">Contacto</a></li>
                    </ul>
                </div>
            ...
            <div class="mt-10 pt-8 border-t border-blue-800 text-center text-blue-300 text-sm">
                <p>&copy; <span id="year"></span> Obesita la Sirenita. Todos los derechos reservados. Diseñado con <i class="fas fa-heart text-pink-400"></i>.</p>
            </div>
        </div>
    </footer>
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        // --- LÓGICA PARA EL GENERADOR DE CUENTOS CON GEMINI API ---
